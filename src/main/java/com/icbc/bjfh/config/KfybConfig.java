...
public class KfybConfig {
		...
		public String toString() {
			return "KfybConfig [value=" + value + ", valueArray=" + Arrays.toString(valueArray) + ", valueList="
					+ valueList + ", valueMap=" + valueMap + ", valueMapList=" + valueMapList + "]";
		}
}
